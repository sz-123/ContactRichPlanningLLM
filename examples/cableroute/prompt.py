prompt = """
You're a robot holding a cable that's above a tunnel with a small opening at the top.
...
- cartesian_admittance_move: This moves the robot to a target_pose until a termination condition is reached.
  Args:
      ...
      virtual_cartesian_inertia:
          ...
          matrix, expressed in the robot base frame [kg, kg m²]
...
# move down until something pushes against the cable
...
# move the cable to the right until a tug towards the left is detected
