...
'<pre style="background-color: #f8f9fa; overflow: visible; white-space: pre-wrap; word-wrap: break-word;"><code class="language-python">' + Prism.highlight(stretch_wo_ft.trim(), Prism.languages.python, 'python') + '</code></pre>';