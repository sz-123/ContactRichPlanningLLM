...
- cartesian_admittance_move: This moves the robot to a target_pose until a termination condition is reached.
  Args:
      max_cartesian_stiffness:
          ...
          the robot base frame. Optional.
      target_impedance:
          (0,1] 6d-vector specifying the target impedance along each cartesian dof. Optional.
      target_pose:
      ...
      virtual_cartesian_inertia:
          ...
          matrix, expressed in the robot base frame [kg, kg m^2]. Optional.
...
import base_t_halfpipe_contact # assume the robot has moved here
"""
