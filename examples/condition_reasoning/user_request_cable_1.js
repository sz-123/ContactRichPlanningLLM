...
var user_request_condition_cable_1 = `
...
document.getElementById('user-request-condition-cable-1-container').innerHTML = '<p>' + user_request_condition_cable_1.trim().replace(/\n/g, '<br>') + '</p>';