...
document.getElementById('user-request-condition-cable-1-container').innerHTML = 
  ...
  '<pre style="background-color: #f8f9fa; overflow: visible; white-space: pre-wrap; word-wrap: break-word;"><code class="language-python">' + Prism.highlight(user_request_condition_cable_1_code.trim(), Prism.languages.python, 'python') + '</code></pre>' +
