...
document.getElementById('cable-skilllib-container').innerHTML = 
  '<pre style="background-color: #f8f9fa; overflow: visible; white-space: pre-wrap; word-wrap: break-word;"><code class="language-python">' + Prism.highlight(cableSkillLib.trim(), Prism.languages.python, 'python') + '</code></pre>';