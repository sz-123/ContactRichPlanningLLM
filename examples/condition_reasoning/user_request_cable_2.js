...
var user_request_condition_cable_2 = `
...
document.getElementById('user-request-condition-cable-2-container').innerHTML = '<p>' + user_request_condition_cable_2.trim().replace(/\n/g, '<br>') + '</p>';